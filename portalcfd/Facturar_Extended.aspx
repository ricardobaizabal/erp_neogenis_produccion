<%@ Page Title="" Language="VB" MasterPageFile="~/portalcfd/MasterPage_PortalCFD.master" AutoEventWireup="false" Inherits="erp_neogenis.portalcfd_Facturar_Extended" MaintainScrollPositionOnPostback="true" CodeBehind="Facturar_Extended.aspx.vb" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <fieldset style="padding: 10px;">
            ...
            <table border="0" cellpadding="2" cellspacing="0" align="left" width="100%">
                ...
                <tr>
                    ...
                    <td colspan ="1"><telerik:RadButton ID="btnAddUiid" runat="server" Text="Agregar" CausesValidation="true" ValidationGroup="uuids"></telerik:RadButton></td>
                    <td colspan="1">&nbsp;</td>
                </tr>
                <tr>
                    <td class="item" colspan="2">
        ...
        <fieldset style="padding: 10px;">
            ...
            <table width="100%" border="0">
                ...
                <tr>
                    ...
                    <td width="25%">
                        <telerik:RadTextBox ID="txtGLNVendedor" runat="server" Text="">
                        </telerik:RadTextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="25%">
                        <telerik:RadTextBox ID="txtNumeroEmisor" runat="server" Text="">
                        </telerik:RadTextBox>
                    </td>
                </tr>
            </table>
    ...
    <asp:Panel ID="panelAddendaCoppel" runat="server" Visible="false">
        <fieldset style="padding: 10px;">
            <legend style="padding-right: 6px; color: Black">
                <asp:Image ID="Image6" runat="server" ImageUrl="~/portalcfd/images/ListaProveedores_03.jpg" ImageAlign="AbsMiddle" />&nbsp;<asp:Label ID="Label2" runat="server" Text="Datos Addenda Coppel Ropa" Font-Bold="true" CssClass="item"></asp:Label>
            </legend>
            <table width="100%" border="0">
                <tr>
                    <td colspan="2" align="center">
                    ...
                    <td colspan="2" align="center">
                        <asp:Label ID="Label4" runat="server" Text="Datos del vendedor(Seller)" Font-Bold="true" CssClass="item"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td colspan="4">&nbsp;</td>
                ...
                <tr>
                    <td width="25%" align="right">
                        <asp:Button ID="btnAddenda" runat="server"  Visible="true"   CausesValidation="false" Text="Generar Addenda" CssClass="item" />
                    </td>
                    <td width="25%">&nbsp;</td>
                    <td width="25%">&nbsp;</td>
                    <td width="25%">&nbsp;</td>
                            ...
                            <MasterTableView Width="100%" DataKeyNames="productoid,existencia,disponibles" Name="Items" AllowMultiColumnSorting="False">
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn UniqueName="talla" Visible="false">
                                        ...
                                        <ItemTemplate>
                                            <telerik:RadNumericTextBox ID="txtTalla" runat="server" MinValue="0" Text='<%#Eval("talla") %>' Skin="Default" Width="50px">
