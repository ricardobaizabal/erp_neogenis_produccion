...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <fieldset>
        <legend style="padding-right:6px; color:Black">
            <asp:Label ID="lblColeccionesList" runat="server" Text="Lista de Temporadas" Font-Bold="true" CssClass="item"></asp:Label>
        </legend>
        <table width="100%" border="0">
            ...
            <tr>
                <td align="right">
                    <asp:Button ID="btnAgregaColeccion" runat="server" Text="Agrega Temporada" CausesValidation="False" CssClass="item" />
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
    ...
    <asp:Panel ID="panelRegistroColeccion" runat="server" Visible="False">
        <fieldset>
            <legend style="padding-right:6px; color:Black">
                <asp:Label ID="lblRegistroDeptoTitle" runat="server" Text="Agregar/Editar Temporada" Font-Bold="True" CssClass="item"></asp:Label>
            </legend>
            <br />
            <table width="100%" border="0">
                <tr valign="top">
