<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/portalcfd/MasterPage_PortalCFD.master" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" CodeBehind="pedidos.aspx.vb" Inherits="erp_neogenis.pedidos" %>
                ...
                <tr>
                    <td>
                        <fieldset>
                            ...
                            <asp:DropDownList ID="filtroclienteid" runat="server" CssClass="box"></asp:DropDownList>&nbsp;&nbsp;&nbsp;Marca:
                            <asp:DropDownList ID="filtromarcaid" runat="server" CssClass="box"></asp:DropDownList>&nbsp;&nbsp;&nbsp;Estatus:
                            <asp:DropDownList ID="filtroestatusid" runat="server" CssClass="box"></asp:DropDownList>&nbsp;&nbsp;&nbsp;
                            <br />
                            <br />
                             Palabra clave: <asp:TextBox ID="txtSearch" runat="server" Width="120px" CssClass="box"></asp:TextBox>&nbsp;&nbsp;&nbsp;
                                Estatus Ola: <asp:DropDownList ID="filtroestatusola" runat="server" CssClass="box"></asp:DropDownList>&nbsp;&nbsp;&nbsp;
...
<%--                <tr>
                ...
                <tr>
                    <td align="left" style="vertical-align: top;" class="item">
                        ...
                        <telerik:RadGrid ID="pedidosList" runat="server" AllowPaging="True" PageSize="50"
                            ...
                            <MasterTableView DataKeyNames="id,cliente, estatusid, estatus,condicionesid,chkFacAutomaticas" ShowHeadersWhenNoRecords="true" NoMasterRecordsText="No hay registros para mostrar." CommandItemDisplay="none">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn>
                                     ...
                                     <telerik:GridTemplateColumn>
                                        <HeaderTemplate>No. Ola </HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="lblola" runat="server" Text='<%#Eval("olaid") %>'></asp:Label>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    <telerik:GridTemplateColumn>
                                        <HeaderTemplate>Estatus ola </HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="ola_estatus" runat="server" Text='<%#Eval("ola_estatus") %>'></asp:Label>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                    <telerik:GridTemplateColumn>
                                        <HeaderTemplate>total_emp</HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="totalEmpaquetado" runat="server" Text='<%#Eval("totalEmpaquetado") %>'></asp:Label>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                                     <telerik:GridTemplateColumn>
                                        <HeaderTemplate>Bodega</HeaderTemplate>
                                        <ItemTemplate>
                                 ...
                                 <%--    <telerik:GridTemplateColumn UniqueName="CheckBoxTemplateColumn" ItemStyle-Width="20" >
                                        <ItemTemplate>
                                            <asp:CheckBox ID="chkconsig" runat="server" CssClass="item" Checked='<%# IIf(Eval("chkcfdid") Is DBNull.Value, "False", Eval("chkcfdid"))%>' AutoPostBack="True" OnCheckedChanged="ToggleRowSelection" />
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                                    </telerik:GridTemplateColumn>--%>
                        ...
                        <div style="display:none">
                            ...
                            <MasterTableView  ShowHeadersWhenNoRecords="true" NoMasterRecordsText="No hay registros para mostrar." CommandItemDisplay="none">
                                ...
                                <Columns>  
                                    ...
                                    <telerik:GridBoundColumn HeaderStyle-BackColor="Silver" HeaderStyle-Width="150" DataField="upc" HeaderText="UPC" UniqueName="sku" HeaderStyle-Font-Size="Small">
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridBoundColumn HeaderStyle-BackColor="Silver" HeaderStyle-Width="180" DataField="ubicacion" HeaderText="Ubicacion" UniqueName="ubicacion" HeaderStyle-Font-Size="Small">
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridBoundColumn HeaderStyle-BackColor="Silver" HeaderStyle-Width="150" DataField="idpago" HeaderText="ID. Pago" UniqueName="idpago" HeaderStyle-Font-Size="Small">
                                    </telerik:GridBoundColumn>                                                                     
                                </Columns>
                                <EditFormSettings>
                                    <EditColumn FilterControlAltText="Filter EditCommandColumn column">
    ...
    <div style="text-align:right;float:inherit;margin-right:5px">
        ...
        <table align="center" width="95%">
            <tr>
                <td>
                    <asp:Label ID="lblErrores" Width="100%"  ReadOnly="true" CssClass="item" runat="server"></asp:Label>
                </td>
            </tr>
        </table>
        <br />
