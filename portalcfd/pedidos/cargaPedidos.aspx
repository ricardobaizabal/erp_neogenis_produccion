<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/portalcfd/MasterPage_PortalCFD.master" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" CodeBehind="cargaPedidos.aspx.vb" Inherits="erp_neogenis.cargaPedidos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <fieldset style="border-color: #cccccc; width: 98%; border-width: 1px; border-style: solid; padding: 10px;">
        <legend title="Pedidos." class="item"><strong>Carga Masiva de Pedidos</strong></legend>
                                        ...
                                        <td align="right" class="item">
                                            <fieldset style="width: 98%">
                                                <legend style="padding-right: 6px; color: Black">
                                                    <asp:Label ID="lblPedidoscsv" runat="server" Font-Bold="true" CssClass="item" Text="Carga Pedidos por CSV."></asp:Label>
                                                </legend>
                                                <div>
                                ...
                                <asp:Panel ID="panelCSVPedidos" runat="server" Visible="false">
                                    <fieldset style="width: 98%">
                                        ...
                                        <telerik:RadGrid ID="resultslistCSVPedidos" CssClass="grids" Width="100%" runat="server" AllowPaging="True" PageSize="50" AllowSorting="True" AutoGenerateColumns="False" CellSpacing="0" GridLines="None" Skin="Simple" HeaderStyle-Font-Size="Small" ShowHeader="true">
                                            ...
                                            <MasterTableView DataKeyNames="id,ordenCompra,precio,cantidad,sku,marca" ShowHeadersWhenNoRecords="true" NoMasterRecordsText="No hay registros para mostrar.">
                                                <Columns>
                                                    <telerik:GridBoundColumn DataField="ordenCompra" ItemStyle-Width="10%" FilterControlAltText="Filter column column" HeaderText="Orden Compra" UniqueName="orden_compra" HeaderStyle-Font-Size="Small">
                                                        <ItemStyle HorizontalAlign="center" />
                                                    </telerik:GridBoundColumn>
                                                    <telerik:GridBoundColumn DataField="sku" ItemStyle-Width="10%" FilterControlAltText="Filter column column" HeaderText="Sku" UniqueName="sku" HeaderStyle-Font-Size="Small">
                                                        <ItemStyle HorizontalAlign="center" />
                                                    </telerik:GridBoundColumn>
                                                    <telerik:GridBoundColumn DataField="cantidad" ItemStyle-Width="10%" FilterControlAltText="Filter column column" HeaderText="Orden Compra" UniqueName="cantidad" HeaderStyle-Font-Size="Small">
                                                        <ItemStyle HorizontalAlign="center" />
                                                    </telerik:GridBoundColumn>
                                                     <telerik:GridBoundColumn DataField="precio" ItemStyle-Width="10%" FilterControlAltText="Filter column column" HeaderText="Precio Unitario" UniqueName="precio" HeaderStyle-Font-Size="Small">
                                                        <ItemStyle HorizontalAlign="center" />
                                                    </telerik:GridBoundColumn>
                                                        <telerik:GridBoundColumn DataField="marca" ItemStyle-Width="10%" FilterControlAltText="Filter column column" HeaderText="Precio Unitario" UniqueName="precio" HeaderStyle-Font-Size="Small">
                                                        <ItemStyle HorizontalAlign="center" />
                                                    </telerik:GridBoundColumn>
                                                   
                                                   <%-- <telerik:GridBoundColumn DataField="cantidad" ItemStyle-Width="5%" HeaderText="Cantidad" UniqueName="Cantidad">
                                                        <ItemStyle HorizontalAlign="center" />
                                                    </telerik:GridBoundColumn>
                                                    <telerik:GridBoundColumn DataField="Precio" runat="server" ItemStyle-Width="10%" HeaderText="Guia" UniqueName="Precio">
                                                        <ItemStyle HorizontalAlign="center" />
                                                    </telerik:GridBoundColumn>--%>
                                                </Columns>
                                                <EditFormSettings>
                                                    ...
                                                    <telerik:RadGrid ID="erroresListPedidos" runat="server" Width="100%" ShowStatusBar="True" ShowFooter="true"
                                                        ...
                                                        <MasterTableView Width="100%" DataKeyNames="id" Name="Productos" AllowMultiColumnSorting="False" NoMasterRecordsText="No se encontraron registros." CommandItemDisplay="Top">
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <telerik:GridBoundColumn DataField="sku" ItemStyle-Width="5%" HeaderText="Sku" UniqueName="idPago">
                                                                    <ItemStyle HorizontalAlign="center" />
                                                                </telerik:GridBoundColumn>
                                                                <telerik:GridBoundColumn DataField="cantidad" runat="server" ItemStyle-Width="10%" HeaderText="Cantidad" UniqueName="guia">
                                                                    <ItemStyle HorizontalAlign="center" />
                                                                </telerik:GridBoundColumn>
