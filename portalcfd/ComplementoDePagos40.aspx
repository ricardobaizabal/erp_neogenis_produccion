<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/portalcfd/MasterPage_PortalCFD.master" CodeBehind="ComplementoDePagos40.aspx.vb" Inherits="erp_neogenis.ComplementoDePagos40" %>
            ...
            <table border="0" cellpadding="2" cellspacing="0" align="left" width="100%">
                <tr>
                    <td class="item" style="width: 25%;">
                        <asp:Label ID="Label4" runat="server" CssClass="item" Font-Bold="true" Text="Cuenta Concentradora:"></asp:Label>
                    </td>
                    <td class="item">&nbsp;</td>
                    <td class="item">&nbsp;</td>
                </tr>
                ...
                <tr>
                    ...
                    &nbsp;
                    <%--<td class="item"> <asp:Label ID="lbluuidrelacionado" runat="server" CssClass="item" Font-Bold="true" Text="UUID Relacionado:"  Visible="false"></asp:Label></td>--%>
                    <td class="item">&nbsp;</td>
                </tr>
                <tr>
                    <td class="item" style="width: 25%;">
                    ...
                    <td class="item">
                        &nbsp;
                        <%--<telerik:RadNumericTextBox ID="txtuuidrelacionado" runat="server" Width="50%" Visible="false"></telerik:RadNumericTextBox>--%>
                    </td>
                    <td class="item">&nbsp;</td>
                </tr>
                <tr>
    ...
    <asp:Panel ID="panelRecepcionPago" runat="server" Visible="false">
        <fieldset style="padding: 10px;">
            ...
            <table width="100%" border="0">
                ...
                <tr>
                    <td colspan="2">
                        <telerik:RadTextBox ID="txtNumOperacion" runat="server" Width="95%" MaxLength="100">
                        </telerik:RadTextBox>
                    </td>
                    <td>
