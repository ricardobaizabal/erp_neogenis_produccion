...
Public Class Etiquetas3
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim etiqueta As DataSet = GetEtiquetaProductosByProductoid(productoid, fecha_act)
    ...
    Public Function GetEtiquetaProductosByProductoid(ByVal productoid As Integer, fecha_act As String) As DataSet
        Dim productodata As New DataSet
        Dim obj As New DataControl
        productodata = obj.FillDataSet("EXEC pStockLocation @cmd=2, @productoid=" & productoid & ",@fecha_act=" & fecha_act)
        Return productodata
    End Function
